...
يتضمن هذا الإصدار عدد من الميزات الهامة، بما في ذلك تنزيل السور والآيات للاستماع دون إنترنت, إلى جانب القارئ البديل وميزات التكرار وإجراءات جديدة في مشغل الآيات والسور، لمساعدتك على الحفظ والمراجعة، وغير ذلك من الميزات، إضافة إلى عدد كبير من التغييرات البرمجية.
...
- تم تحديث Python إلى Python 3.13.9 و QT إلى أحدث إصدار، قد تلاحظ تحسن كبير في سرعة فتح البرنامج.
- تمت إعادة بناء نظام إنشاء دليل الاستخدام، يتم عرض جدول المحتوى في بداية الملف بشكل هرمي مع دعم القوائم المتداخلة والترتيب التصاعدي لأرقام العناوين، إلى جانب دعم التمرير البطيء وفتح الروابط الخارجية في تبويبة جديدة والمزيد.
...
- تم تحديث ملحقات البيان المستخدمة إلى أحدث الإصدارات.
