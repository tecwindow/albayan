...
- أصبح بإمكانكتفعيل أو تعطيل ميزة استعادة الموضع المحفوظ عند فتح البيان في الإعدادات العامة، عند تعطيلها يبدأ البيان من سورة الفاتحة دائمًا، ويمكنك استعادة الموضع المحفوظ بشكل يدوي في أي وقت عن طريق Ctrl+Backspace أو خيار الذهاب إلىة الموضع المحفوظ في قائمة تنقل.
...
- تم تحديث نظام الصوت Bass إلى الإصدار Bass 2.4.18.3.
