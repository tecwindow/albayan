...
class TasbihDialog(QDialog):
    def __init__(self, parent) -> None:
        ...
        self.entryLineEdit.setPlaceholderText("Enter new Tasbih")
        self.addButton = QPushButton("Add Tasbih")
        self.addButton.setEnabled(False)
        self.delete_button = QPushButton("Delete Tasbih")
        self.delete_button.setEnabled(False)
        self.incrementButton = QPushButton("Increment Counter")
        self.incrementButton.setEnabled(False)
        self.resetButton = QPushButton("Reset Counter")
        self.resetButton.setEnabled(False)
        
        # Layout.
        layout = QVBoxLayout()
        layout.addWidget(QLabel("Tasbih Entries:"))
        layout.addWidget(self.listWidget)
        layout.addWidget(QLabel("New Tasbih:"))
